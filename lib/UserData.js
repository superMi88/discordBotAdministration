...
class UserData {
    ...
    async save(plugin = null) {
        ...
        if (this._modifiedCurrencies.size > 0) {
            ...
            } else if (!plugin && process.env.NODE_ENV !== 'production' && typeof window === 'undefined') {
                // In Website context we might not have a plugin object. 
                // We allow it but log a warning if needed? 
                // Website setCurrency handler usually shouldn't have a plugin object.
            }
